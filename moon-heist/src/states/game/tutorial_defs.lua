TUTORIAL_DEFS = {
    [99] = {
        name = 'yellow-win',
            ...
            height = 80,
            text = "You had successfully built the level 3 Space Harbour. Root 67 planned to start the Earth-Moon Space Immigration very shortly. What lies in front was a brand new era of discovery.\n"..
